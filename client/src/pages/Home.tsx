  ...
  return <div className="isometric-stage min-h-screen overflow-hidden bg-[#f8fcfd] text-[#173247]">
    ...
    <main className="relative z-10 mx-auto w-full max-w-[1440px] px-5 pb-14 lg:px-10">
      ...
      {analysis ? <>
        ...
        {/* Place this immediately after the section that contains Areas for improvement and Detected career toolkit */}
        <section className="mt-9">
          <div className="rounded-[1.6rem] bg-[#173b55] p-6 text-white shadow-[8px_9px_0_#a7ece7] sm:p-7">
            <div className="flex items-center gap-2 text-[#aaf4ed]">
              <BrainCircuit className="h-5 w-5" />
              <p className="mono-label text-[9px]">AI career coach</p>
            </div>

            <h2 className="mt-3 text-2xl font-bold leading-6 tracking-[-0.06em]">
              Turn your match data into an action plan.
            </h2>

            <p className="mt-3 text-xs leading-5 text-[#b5d2dd]">
              Get tailored learning priorities and resume refinements from your server-side AI coach.
            </p>

            <button
              onClick={generateInsight}
              disabled={aiInsight.isPending}
              className="mt-5 inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-xl bg-[#4dd7cb] px-4 text-sm font-bold text-[#14364c] transition-transform duration-150 hover:bg-[#74e3d9] disabled:cursor-wait disabled:opacity-70 active:scale-[0.98]"
            >
              {aiInsight.isPending ? (
              ...
              {aiInsight.isPending ? "Building your plan" : "Generate AI insight"}
            </button>
          </div>
        </section>
      ...
      {/*}
      <CareerChatbot analysis={analysis} />
      {*/}
    </main>
  </div>;
}
